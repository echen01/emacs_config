...
;; ## added by OPAM user-setup for emacs / tuareg ## 5ff1b81bb7a021c9b767184e81c68f0b ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/eric/.opam/cs3110-final/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
